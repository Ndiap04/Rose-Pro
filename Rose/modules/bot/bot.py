"""
jika Anda bisa membaca ini, berarti Anda menggunakan kode dari Ya ampun | Proyek Ram
...
©2023 SM|Sukses Makmur Projects
"""
import traceback
...
async def on_plug_in_cb(_, callback_query: CallbackQuery):
    ...
    this_command += "©SM|Sukses Makmur PROJECT"
    bttn = [
